...
* Description: inserts a new song of users choice to the front of the list
* Input parameters: head
* Returns: none
* Preconditions: the list must be accessible
* Postconditions: the new song is at the head of the list
*************************************************************/
...
* Date Created: 2/7/25
* Date Last Modified: 2/7/25
* Description: deletes a song from the list that the user choses
* Input parameters: head
* Returns: none
* Preconditions: the node must be accessible
* Postconditions: the node will be deleted from the list
*************************************************************/
...
* Function:	sort
* Date Created: 2/8/25
* Date Last Modified: 2/8/25
* Description: sorts the list by choice of artist, album, plays, and rating
* Input parameters: head
* Returns: none
* Preconditions: the node must be accessible
* Postconditions: The list becomes sorted based on the user choice
*************************************************************/
void sort(Node** head);
...
* Date Created: 2/8/25
* Date Last Modified: 2/8/25
* Description: plays songs in a random order
* Input parameters: head
* Returns: none
* Preconditions: the node must be accessible
* Postconditions: the songs are "played" in a random order
*************************************************************/
